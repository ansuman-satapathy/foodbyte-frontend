...
This repository contains the React application code for the **FoodByte Frontend**, providing a high-fidelity user interface for the platform.
...
This application does not push deployments to the cluster directly. Deployments are handled asynchronously, powered by the Flux Operator viewing the `foodbyte-gitops` configuration.

The automated delivery flow operates as follows:

1. Code is pushed to the `foodbyte-frontend` repository.
